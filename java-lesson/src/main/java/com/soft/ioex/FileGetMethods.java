...
public class FileGetMethods {
    public static void main(String[] args) {
        File f = new File("E:/code/JavaStudy/java-parent/java-basic/src/main/java/top/xkk/java/basic/array/ArrayOperation.java");
        ...
        File f2 = new File("E:/code/JavaStudy/java-parent/java-basic/src/main/java/top/xkk/java/basic/array");
